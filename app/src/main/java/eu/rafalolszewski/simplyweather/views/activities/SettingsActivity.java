...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static final String WIND_UNIT_KEY = "settings.wind.unit";
    public static final int WIND_UNIT_DEFAULT = 0;
    public static final int WIND_UNIT_MPS = 0;
    public static final int WIND_UNIT_KMH = 1;

    public static final String TEMP_UNIT_KEY = "settings.temp.unit";
    public static final int TEMP_UNIT_DEFAULT = 0;
    public static final int TEMP_UNIT_CELSIUS = 0;
    public static final int TEMP_UNIT_KELVIN = 1;
